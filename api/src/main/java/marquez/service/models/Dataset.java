...
public abstract class Dataset {
  ...
  @Nullable private final String lastLifecycleStateChange;
  ...
  public Dataset(
    ...
    this.lastLifecycleStateChange = lastLifecycleStateChange;
  ...
  public Optional<String> getLastLifecycleStateChange() {
    return Optional.ofNullable(lastLifecycleStateChange);
  }
