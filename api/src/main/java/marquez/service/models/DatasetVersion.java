...
public abstract class DatasetVersion {
  ...
  @Nullable private final String lifecycleStateChange;
  ...
  public DatasetVersion(
      ...
      @Nullable final String lifecycleStateChange,
  ...
  public Optional<String> getLifecycleStateChange() {
    return Optional.ofNullable(lifecycleStateChange);
  }
