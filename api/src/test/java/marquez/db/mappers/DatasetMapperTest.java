...
class DatasetMapperTest {
  ...
  public static void setUp() throws SQLException, MalformedURLException {
    ...
    when(resultSet.getString(Columns.LIFECYCLE_STATE_CHANGE)).thenReturn("TRUNCATE");
    when(resultSet.getObject(Columns.LIFECYCLE_STATE_CHANGE)).thenReturn("TRUNCATE");
